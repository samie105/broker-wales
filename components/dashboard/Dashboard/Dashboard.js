...
export default function Dash() {
  ...
  //           <ToastAction
  //             altText="Deposit"
  //             className={`font-bold bg-[#cf0000] text-white`}
  //           >
              ...
              <div className="card-info shado-md flex items-center justify-between">
                <div className="card-header font-bold ml-1 flex items-center /text-white">
                  <div className="block">
                    {" "}
                    <div
                      className={`icon-cont bg-gry-50 text-[#cf0000]  ${
                        isDarkMode ? " bg-[#cf000030]" : "border bg-[#cf000010]"
                ...
                <div className="card-info flex">
                  <Link href="/dashboard/withdrawals" passHref>
                    ...
                    <div
                      className={`mx-1 ${
                        isDarkMode
                          ? "text-[#cf0000] bg-[#cf000020]"
                          : "bg-[#cf000010] text-[#cf0000]"
                  ...
                  <Link href="dashboard/deposits" passHref>
                    {" "}
                    <div className="mx-1 bg-[#cf0000] text-white flex font-bold text-xs items-center cursor-pointer md:px-4 md:py-3 p-3 rounded-full md:rounded-lg">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20"
                        fill="currentColor"
        ...
        {details === 0 ? (
          ...
          >
            <div className="flex items-center gap-x-2">
              <div className="icon">
                <div
                  className={`rounded-full text-[#cf0000] p-3 ${
              ...
              <div className="trading-bar w-full">
                ...
                <div className="progress mt-2">
                  ...
                  >
                    <div
                      className="bar absolute top-0 left-0 h-full rounded-full bg-[#cf0000]"
