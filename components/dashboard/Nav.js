        ...
        {details === 0 ? (
          ...
          <div className="nav-tools text-sm flex items-center">
                  ...
                  >
                    ...
                    <div
                      className={`hidden md:block  ${
                        isDarkMode ? "text-[#009688]" : "text-[#009688]"
                      }`}
                    >
                      Notifications
                    </div>
            ...
            <Popover>
              <PopoverTrigger>
                <div
                  className={`flex font-bold text-[#009688] rounded-full md:p-3 ${
                    isDarkMode ? "md:bg-[#00968820]" : "md:bg-[#00968810]"
                  } md:mr-5 text-sm`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
