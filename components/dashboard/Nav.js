        ...
        {details === 0 ? (
          ...
          <div className="nav-tools text-sm flex items-center">
                  ...
                  >
                    ...
                    <div
                      className={`hidden md:block  ${
                        isDarkMode ? "text-[#cf0000]" : "text-[#cf0000]"
                      }`}
                    >
                      Notifications
                    </div>
            ...
            <Popover>
              <PopoverTrigger>
                <div
                  className={`flex font-bold text-[#cf0000] rounded-full md:p-3 ${
                    isDarkMode ? "md:bg-[#cf000020]" : "md:bg-[#cf000010]"
                  } md:mr-5 text-sm`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
