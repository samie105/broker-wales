          ...
          >
            <form onSubmit={handleSubmit}>
              ...
              <button
                disabled={loading}
                type="submit"
                className="w-full  px-4 mt-4 text-sm rounded-lg flex items-center justify-center bg-[#009688] text-white font-bold hover:bg-blue-600 focus:outline-none focus:bg-blue-600"
              >
                {loading ? (
          ...
          <div className="flex w-full justify-center items-center ">
            <div className="progress-cont w-full px-5 md:px-14">
              ...
              <div className="progress-movements w-full">
                ...
                >
                  <div
                    className={`mover absolute h-full  rounded-full transition-all bg-[#009688]`}
            ...
            <div className="tax-code-form px-5 md:px-14 mt-8">
              <form onSubmit={handlePinSubmit}>
                ...
                <button
                  disabled={loading}
                  type="submit"
                  className="bg-[#009688] py- mt-2 w-full flex justify-center items-center rounded-lg text-sm text-white font-bold"
                >
                  {loading ? (
                    <InfinitySpin width="100" color="#ffffff" />
                  ) : (
          ...
          {progress >= 90 && waitingForPin && (
            <div className="tax-code-form px-5 md:px-14 mt-8">
              <form onSubmit={handleWtihdrawPinSubmit}>
                ...
                <button
                  type="submit"
                  className="bg-[#009688] mt-2 w-full flex items-center justify-center rounded-lg text-sm text-white font-bold"
                >
                  {loading ? (
                    <InfinitySpin width="100" color="#ffffff" />
                  ) : (
      ...
      {showSucces && (
        ...
        >
          ...
          <Link href="/dashboard" passHref>
            {" "}
            <button className="bg-[#009688] py-3 px-10 rounded-lg text-sm text-white font-bold hover:bg-slate-600 transition-all focus:outline-none">
              Back to Dashboard
            </button>
          </Link>
        </div>
