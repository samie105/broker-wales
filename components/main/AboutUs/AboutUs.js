        ...
        <div className="second-cont pt-8 md:pt-0 mb-1 md:w-2/3 mr-10">
          <div className="inner-cont">
            ...
            <div
              ...
              data-aos="fade-left"
            >
              Get <span className="text-[#009688]">Exceptional</span> Services!!
            </div>
            ...
            <Link href="/auth" passHref className="flex">
              <div
                ...
                data-aos="fade-up"
              >
                <div className="px-5 py-4 bg-[#009688] text-white font-semibold text-sm items-center rounded-xl flex">
              ...
              >
                <div className="stepHead ">
                  <div className="small-text">
                    <div className="cont flex items-center uppercase font-semibold opaity-70 text-xs">
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="w-4 h-4 mr-2 text-[#009688]"
                      >
                        <path
                          fillRule="evenodd"
                  ...
                  <div className="large-text capitalize text-lg py-2 font-semibold ml-3">
                    <p>
                      Safe & <span className="text-[#009688]">Secure</span>{" "}
                    </p>
                  </div>
                </div>
            ...
            <div className="card2">
              ...
              >
                <div className="stepHead ">
                  ...
                  <div className="large-text capitalize text-lg py-2 font-semibold ml-3">
                    <p>
                      Profitable <span className="text-[#009688]">Assets</span>{" "}
                    </p>
                  </div>
                </div>
                <div className="stepBody">
            ...
            <div className="card1 my-2 md:my-0">
              ...
              >
                <div className="stepHead ">
                  ...
                  <div className="large-text capitalize text-lg py-2 font-semibold ml-3">
                    <p>
                      <span className="text-[#009688]">Secure </span>
                      Wallet{" "}
                    </p>
                  </div>
                </div>
            ...
            <div className="card2">
              ...
              >
                <div className="stepHead ">
                  ...
                  <div className="large-text capitalize text-lg py-2 font-semibold ml-3">
                    <p>
                      <span className="text-[#009688]">Instant</span>{" "}
                      Withdrawals
                    </p>
                  </div>
                </div>
