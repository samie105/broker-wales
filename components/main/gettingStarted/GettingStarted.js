      ...
      >
        ...
        <div className="textSection lg:w-1/2 md:w-1/2 mt-10 z-20">
          ...
          <div className="mainTitle mt-3 mx-3">
            ...
            >
              <p>
                How It <span className="text-[#009688]">Works?</span>{" "}
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              <div className="stepHead ">
                ...
                <div className="large-text capitalize text-lg py-2 font-semibold ml-3">
                  <p>
                    make a <span className="text-[#009688]">deposit</span>{" "}
                  </p>
                </div>
              </div>
              <div className="stepBody">
          ...
          >
            ...
            >
              <div className="stepHead ">
                ...
                <div className="large-text capitalize text-lg py-2 font-semibold ml-3">
                  <p>
                    <span className="text-[#009688]">Trading</span> Interception
                  </p>
                </div>
              </div>
              <div className="stepBody">
            ...
            >
              <div className="stepHead ">
                ...
                <div className="large-text capitalize text-lg py-2 font-semibold ml-3">
                  <p>
                    Make <span className="text-[#009688]">withdrawal</span>{" "}
                    request
                  </p>
                </div>
              </div>
